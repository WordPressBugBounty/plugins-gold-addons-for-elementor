...
$columns        = isset( $settings['grid_columns'] ) ? $settings['grid_columns'] : 'ga-blog-columns-2';
...
<div id="ga-blog-posts" class="ga-blog-layout-grid <?php echo esc_attr( $columns ); ?>">
    ...
    <?php if( $the_query->have_posts() ): ?>
        ...
        <?php while( $the_query->have_posts() ): $the_query->the_post(); ?>
            <div class="ga-blog-entry ga-clearfix">
                ...
                <div class="ga-grid-entry-content-wrapper">
                    ...
                    <ul class="ga-blog-entry-meta ga-clearfix">
                        ...
                        <?php if( 'yes' == $settings['meta_date'] ): ?>
                            <li><i class="ga-icon-calendar"></i> <?php the_date( $date_format ); ?></li>
                        <?php endif; ?>

                        <?php if( 'yes' == $settings['meta_author'] ): ?>
                        <li><i class="ga-icon-user"></i> <a href="<?php echo esc_url( $author_posts_url ); ?>"><?php echo ucfirst( get_the_author() ); ?></a></li>
                        <?php endif; ?>

                        <?php if( 'yes' == $settings['meta_category'] ): ?>
                            <li><i class="ga-icon-folder"></i> <?php the_category( ', ' ); ?></li>
                        <?php endif; ?>

                        <?php if( 'yes' == $settings['meta_comments'] ): ?>
                            <li><i class="ga-icon-message-circle"></i> <?php echo get_comments_number(); ?></li>
                        <?php endif; ?>
