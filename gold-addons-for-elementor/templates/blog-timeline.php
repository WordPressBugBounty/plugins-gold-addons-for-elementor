...
<div class="ga-blog-timeline-wrapper">

    <div id="ga-blog-posts" class="ga-blog-layout-timeline">
        ...
        <?php if( $the_query->have_posts() ): ?>
            ...
            <?php endif; ?>
                ...
                <div class="ga-blog-timeline-border"></div>

                <?php while( $the_query->have_posts() ): $the_query->the_post(); ?>
                    <div class="ga-blog-entry ga-clearfix">

                        <div class="ga-blog-entry-timeline">
                            <?php echo get_the_date('d'); ?>
                            <span><?php echo get_the_date('M'); ?></span>
                            <div class="ga-blog-entry-timeline-divider"></div>
                        </div>
